...
> **Question 15**: Copy the remote address and the **Host** request
...
> **Question 16**: Copy the remote address and the **Host** request
...
> **Question 17**: Copy the remote address and the **Host** request
